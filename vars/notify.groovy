...
def call(Map config, Closure body) {
	...
	try {
		...
		githubNotify account: 'Mobi-Market', context: buildKey, credentialsId: '1ff0d140-8690-4233-9ff5-870d3e648cae', description: 'Error ' + step + ': ' + err.toString(), gitApiUrl: '', repo: system, status: 'FAILURE'
		throw err
	}
}
