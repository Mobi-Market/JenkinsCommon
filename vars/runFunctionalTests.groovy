...
def call(Map config) {
	...
	xunit([JUnit(deleteOutputFiles: true, failIfNotNew: true, pattern: 'Reports/**/JenkinsFunctional-phpunit-junit.xml', skipNoTestFiles: false, stopProcessingIfError: true)])
}